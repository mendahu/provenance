...
| [Aggregate workspace nav counts](aggregate-workspace-nav-counts.md) | One FFI RPC for all sidebar badge counts (plus vocabulary origin splits) instead of N serial list/count calls. |
