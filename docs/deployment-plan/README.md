...
- [`spike-2/README.md`](spike-2/README.md) — task list (S2-01…S2-23; IDs are sparse — see dependency sketch)
- [`spike-2/design/`](spike-2/design/) — Claude Design requirement briefs (S2-01…S2-04, S2-20, S2-23)
